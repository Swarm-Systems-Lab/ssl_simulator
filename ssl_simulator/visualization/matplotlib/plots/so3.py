...
from ssl_simulator.visualization import PlotBase, plot_so3_attitude_vectors
from ssl_simulator.visualization import update_quivers, update_scatters
...
class SO3Plot(PlotBase):
    def __init__(self,  R_data, p_data=None, sphere=True, **kwargs):
        ...
        self.p_data = check_and_parse_dimensions(p_data, (None,None,3), "p_data") if p_data is not None else None
    ...
    def init_artists(self):
        ...
        artists_attitude = plot_so3_attitude_vectors(self.R_data, self.p_data, ax=ax1, arr_len=1.0, quiver_thickness=2, sphere=self.sphere)
